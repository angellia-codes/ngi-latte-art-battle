...
import { UserPlus, ChevronDown, ChevronUp, CheckCircle, Coffee } from "lucide-react";
      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-[#D4A373] font-[family-name:var(--font-syne)] font-bold tracking-wider text-sm">
              NOURISH × EXPAT
            </span>
          </div>
